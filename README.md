...
**Raspberry Pi 5 appliance only** — table-tennis instant replay: live 1080p50/60 on audience HDMI, rolling ~20 s buffer on USB3 SSD, Mark / Replay / Last / Live via **native touch UI** and **USB keyboard hotkeys**.

**GitHub (Pi):** [github.com/madgunman/InstaReplayPi](https://github.com/madgunman/InstaReplayPi) — clone, releases, and `scripts/install-instant-replay.sh` on the device. See [docs/GITHUB_PI.md](docs/GITHUB_PI.md).
...
See **QUICKSTART.md** and **docs/PI_DEPLOYMENT.md**.
...
make accept-full          # cargo test + headless engine smoke
